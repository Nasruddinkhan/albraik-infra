...
public class UserController {
	...
	public ResponseEntity<List<UserDTO>> getUserJobtitle(@PathVariable String name, @PathVariable Integer companyId) {
	...
	/**
	 * This api is used by other microservices to fetch user details
	 * 
	 * @param principal
	 * @return
	 */
